namespace Skyline.DataMiner.PollingManager
{
	...
	public abstract class PollableBase : IPollable
	{
		...
		public PollableBase(SLProtocol protocol, string name)
		{
			...
			Interval = 5;
			DefaultInterval = 10;
			IntervalConfig = IntervalConfig.Default;
			LastPoll = default;
		...
		public IntervalConfig IntervalConfig { get; set; }
		...
		public void Update(object[] row)
		{
			...
			IntervalConfig = (IntervalConfig)Convert.ToDouble(row[(int)Column.IntervalConfig]);
